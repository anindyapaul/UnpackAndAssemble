...
NTSTATUS PagefaultUnload(IN PDRIVER_OBJECT DriverObject)
{
	...
	DbgPrint("PagefaultUnload called\r\n");	
    ...
    )
{
    ...
    ULONG                   ioControlCode;
    NTSTATUS				ntstatus;
DbgPrint("PagefaultDispatch called\r\n");	
    ...
    ) 
{
	...
	PEPROCESS eproc = NULL;
    	IOCTLPARAMS 	*params;
	char buf[100];
	DbgPrint("PagefaultDeviceControl called\r\n");	
...
{
	//DebugPrint("HookMemoryPage called\r\n");	
